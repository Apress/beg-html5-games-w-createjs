...
function preload() {
    preloader = new ui.Preloader('#fff', '#ffd700');
    preloader.x = (canvas.width / 2) - (preloader.width / 2);
    preloader.y = (canvas.height / 2) - (preloader.height / 2);
    stage.addChild(preloader);
    queue = new createjs.LoadQueue();
    queue.addEventListener('progress', onPreloadProgress);
